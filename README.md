![](https://img.shields.io/badge/Jupyter-Kernel-green?link=https://jupyter.org/&link=https://github.com/jupyter/jupyter/wiki/Jupyter-kernels) ![](https://img.shields.io/badge/MyMermaid-Kernel-orange) ![](https://img.shields.io/github/watchers/nufeng1999/jupyter-MyMermaid-kernel) <img alt="ViewCount" src="https://views.whatilearened.today/views/github/nufeng1999/jupyter-MyMermaid-kernel.svg">
    <a href="https://github.com/nufeng1999/jupyter-MyMermaid-kernel"><img alt="GitHub Clones" src="https://img.shields.io/badge/dynamic/json?color=success&label=Clone&query=count&url=https://raw.githubusercontent.com/nufeng1999/jupyter-MyMermaid-kernel/master/clone.json&logo=github"></a>
# MyMermaid kernel for Jupyter  
[Example](https://github.com/nufeng1999/jupyter-MyMermaid-kernel/blob/master/example/MyMermaid.ipynb "Example")
...
pip install zerorpc
git clone https://github.com/nufeng1999/jupyter-MyMermaid-kernel.git
cd jupyter-MyMermaid-kernel
pip install -e . 
cd jupyter_MyMermaid_kernel && python3 install_MyMermaid_kernel --user
